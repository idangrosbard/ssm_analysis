...
# fmt: off
def slow_forward_for_ssm_manipulation(module, input_states, cache_params: Optional[MambaCache]=None, cache_position:Optional[torch.LongTensor]=None, attention_mask: Optional[torch.LongTensor] = None, feature_mask: torch.Tensor = None, factor: float = 1, factored_tokens: Optional[torch.Tensor] = None):
    """
