...
# fmt: off
def slow_forward_for_ssm_knockout(module, input_states, cache_params: Optional[MambaCache]=None, cache_position:Optional[torch.LongTensor]=None, attention_mask: Optional[torch.LongTensor] = None, mask: torch.Tensor = None):
    """
    ...
    scan_output = scan_output * mask[None, :, None]
