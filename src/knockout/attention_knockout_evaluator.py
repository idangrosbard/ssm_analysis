...
class AttentionKnockoutEvaluator(KnockoutEvaluator):
    def __init__(self, model: MambaForCausalLM, tokenizer: AutoTokenizer, device: torch.device,knockout_target: KnockoutTarget, affected_target: KnockoutTarget, drop_subj_last: bool = False, show_progress: bool = False):
        self.model = model
