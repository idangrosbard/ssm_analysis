...
class AdaptedMixer(nn.Module):
    ...
    def forward(
        ...
        return self.slow_forward_for_ssm_manipulation(
            self.inner_module,
            input_states,
            cache_params,
            cache_position,
    ...
    def slow_forward_for_ssm_manipulation(
        self,
        module,
        input_states,
        cache_params: Optional[MambaCache] = None,
        ...
        factor: float = 1,
        factored_tokens: Optional[torch.Tensor] = None,
    ):
        """
        ...
        if cache_params is not None:
            ...
            if cache_position.shape[0] == module.conv_kernel_size:
                ...
                hidden_states = module.act(
                    module.conv1d(hidden_states)[..., :seq_len]
                ...
                hidden_states = (
                    module.act(hidden_states).to(dtype).unsqueeze(-1)
        ...
        time_step, B, C = torch.split(
            ssm_parameters,
            [module.time_step_rank, module.ssm_state_size, module.ssm_state_size],
            dim=-1,
        )
