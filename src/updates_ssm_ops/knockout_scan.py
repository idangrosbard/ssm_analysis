...
def knockout_scan(seq_len: int, ssm_state: Tensor, discrete_A: Tensor, deltaB_u: Tensor, C: Tensor, knockout_start_idx: int, knockout_end_idx: int, knockout_mode: KnockoutMode, dtype) -> List[Tensor]:
